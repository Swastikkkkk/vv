  ...
  return (
    <header className="w-full bg-white shadow-md sticky top-0 z-50">
      <div className="max-w-[1440px] mx-auto px-6 md:px-10 py-4 flex flex-col md:flex-row items-center justify-between gap-4 md:gap-0">
        {/* Logo */}
        <div className="flex items-center space-x-3">
          <img src={logo} alt="Rewear Logo" className="h-16 w-auto object-contain" />
        </div>
        ...
        {/* Right side - Buttons and Language */}
        <div className="flex flex-col md:flex-row items-center justify-end gap-6 w-full md:w-auto mt-1">
          {/* Buttons */}
          <div className="flex gap-3 w-full md:w-auto">
            <button
              onClick={handleSignInClick}
          ...
          {/* Language selector */}
          <div className="flex flex-col md:flex-row items-center gap-2 md:ml-6">
