...
const HeroSection = () => {
  return (
    <section
      className="w-full h-screen bg-cover bg-center relative flex items-start justify-center"
    ...
    >
      ...
      <div className="relative z-10 text-center text-white px-4 pt-[20vh] w-full">
