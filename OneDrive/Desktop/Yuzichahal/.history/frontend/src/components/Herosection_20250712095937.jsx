...
const HeroSection = () => {
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-4xl text-center text-white px-6 md:px-12 mt-[120px] pb-[100px]">
        <h1 className="ml-10 text-4xl md:text-6xl lg:text-7xl font-bold mb-6 drop-shadow-2xl leading-tight">
          Welcome to Rewear
        </h1>
